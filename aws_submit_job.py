            ...
            if status == 'SUCCEEDED':
                ...
                try:
                    ...
                    if 'Contents' in objects:
                        ...
                        print(f"\n💡 Download results:")
                        print(f"   aws s3 sync s3://{output_bucket}/{output_prefix}/{job_id}/ ./output_{job_id}/ --profile b3tr")
                ...
                if 'container' in job_desc and 'logStreamName' in job_desc['container']:
                    log_stream = job_desc['container']['logStreamName']
                    print(f"\n📋 Check logs:")
                    print(f"   aws logs tail /aws/batch/ai-music-generator --follow --log-stream-names {log_stream} --profile b3tr")
                else:
