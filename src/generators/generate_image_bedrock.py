...
def generate_with_bedrock_sdxl(prompt, output_path, width=1280, height=720):
    ...
    print(f"🎨 Generating image with AWS Bedrock (Stable Diffusion XL)...")
...
def generate_with_bedrock_titan(prompt, output_path, width=1280, height=720):
    ...
    print(f"🎨 Generating image with AWS Bedrock (Amazon Titan)...")
    print(f"   Resolution: {width}x{height}")
...
def generate_image_bedrock(prompt, output_path="output/cover.png", model="sdxl", width=1280, height=720):
    ...
    print(f"\n{'='*60}")
    print(f"🎨 AWS Bedrock Image Generation")
    print(f"{'='*60}")
    ...
    if model == "sdxl":
        ...
        print(f"💡 Available models: sdxl, titan")
        return None
...
def main():
    ...
    parser.add_argument('--model', type=str, default='sdxl', choices=['sdxl', 'titan'],
