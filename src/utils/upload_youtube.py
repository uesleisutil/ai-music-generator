...
def upload_video(video_path, title, description="", tags=None, category="10", privacy="public"):
    ...
    body = {
        "snippet": {"title": title, "description": description, "tags": tags or [], "categoryId": category},
...
def main():
    ...
    upload_video(args.video, args.title, args.description, tags, privacy=args.privacy)
